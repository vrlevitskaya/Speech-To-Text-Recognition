...
dropdown_with_languages_tab1 = gr.Dropdown(choices=available_languages,
                                           label="Choose language to translate in")
dropdown_with_languages_tab2 = gr.Dropdown(choices=available_languages,
                                           label="Choose language to translate in")
